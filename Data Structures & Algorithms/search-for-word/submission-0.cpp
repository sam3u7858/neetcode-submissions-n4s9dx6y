...
public:
    ...
    bool dfs(vector<vector<char>>& board, vector<vector<bool>>& visited, string word, int wordIndex, int x, int y){
        ...
        result = dfs(board, visited, word, wordIndex+1, x + 1, y) || dfs(board, visited, word, wordIndex+1, x - 1, y) || dfs(board, visited, word, wordIndex+1, x, y + 1) ||  dfs(board, visited, word, wordIndex+1, x, y - 1);
